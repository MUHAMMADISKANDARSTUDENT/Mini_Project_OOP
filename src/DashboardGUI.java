...
public class DashboardGUI extends JFrame {
    ...
    public DashboardGUI() {
        ...
        JButton userButton = new JButton("User Management (User)");
        JButton roomButton = new JButton("Room Management (HotelRoom)");
        JButton reservationButton = new JButton("Reservation Management (Reservation)");
        JButton paymentButton = new JButton("Payment Management (Payment)");
